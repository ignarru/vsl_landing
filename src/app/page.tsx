...
export default function Home() {
  return (
    <>
      ...
      {/* ── RESULTADOS REALES ── */}
      <section className="py-14 sm:py-16 px-4 sm:px-8 lg:px-12 border-t border-border">
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={s.val}
                className="text-center py-5 sm:py-6 px-3 rounded-xl sm:rounded-2xl bg-surface border border-border"
              >
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
            ...
            <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8">
              <p className="text-ink3 text-xs uppercase tracking-widest font-bold mb-5">
                Hoy sin IA
              </p>
            ...
            {/* Despues */}
            <div className="bg-blue/5 border border-blue/10 rounded-2xl p-6 sm:p-8">
              <p className="text-blue3 text-xs uppercase tracking-widest font-bold mb-5">
                Con <Brand size="text-xs" />
              </p>
              <div className="space-y-4">
                {[
          ...
          <div className="text-center mt-8 sm:mt-10">
            <a
              href="#agendar"
              className="cta-pulse inline-flex items-center gap-2 bg-blue hover:bg-blue2 text-white font-semibold px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl text-base sm:text-lg transition-all hover:-translate-y-0.5"
            >
              Agendar llamada de 15 min
            </a>
          </div>
      ...
      {/* ── TESTIMONIO ── */}
      <section className="py-16 sm:py-20 px-4 sm:px-8 lg:px-12 border-t border-border relative">
        ...
        <div className="relative w-full max-w-7xl mx-auto">
          <p className="text-blue3 text-xs sm:text-sm font-semibold uppercase tracking-widest mb-6 sm:mb-8 text-center">
            Caso real
          </p>

          <div className="bg-surface2 border border-border2 rounded-2xl p-6 sm:p-10 lg:p-12">
            <svg
              width="32"
              height="32"
              viewBox="0 0 24 24"
              fill="currentColor"
              className="text-blue/25 mb-4 sm:mb-6"
            >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-blue/12 border border-blue/20 flex items-center justify-center text-blue3 text-sm font-bold">
                RN
              </div>
              <div>
        ...
        <div className="w-full max-w-7xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-5 mb-10 sm:mb-12">
            {[
              ...
              <div
                key={s.step}
                className="bg-surface border border-border rounded-2xl p-6 sm:p-7 text-left"
              >
      ...
      {/* ── CTA FINAL + CAL.COM ── */}
      <section id="agendar" className="py-16 sm:py-20 px-4 sm:px-8 lg:px-12 border-t border-border relative">
        <div className="absolute inset-0 pointer-events-none">
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t border-border py-6 sm:py-8 px-4 text-center">
        <Brand size="text-lg sm:text-xl" />
